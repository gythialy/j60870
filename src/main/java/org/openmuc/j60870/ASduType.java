 ...
 *
 * <ul>
 *   <li>A - can be 'M' for information in monitor direction, 'C' for system information in control
 *       direction, 'P' for parameter in control direction or 'F' for file transfer.
 *   <li>BB - a two letter abbreviation of the function of the message (e.g. "SC" for Single
 *       Command)
 *   <li>CC - additional information to distinguish different messages with the same function (e.g.
 *       "NA" for no timestamp and "TA" for with timestamp)
 * </ul>
 */
public enum ASduType {
    ...
    /**
     * Returns the ASduType that corresponds to the given ID. Returns <code>null</code> if no ASduType
