...
public class ClientServerITest {
    ...
    public void testClientServerMultiThread() throws Exception {
        ...
        clientConnection.interrogation(
                commonAddress, CauseOfTransmission.ACTIVATION, new IeQualifierOfInterrogation(20));
        while (!isClosed.get()) {
            Thread.sleep(1);
    ...
    public void testClientServerCom() throws Exception {
        ...
        try (Connection clientConnection = new ClientConnectionBuilder("127.0.0.1")
            ...
            int commonAddress = 2;
            clientConnection.singleCommand(
                    Util.convertToCommonAddress(63, 203),
            ...
            clientConnection.send(new ASdu(
                    ASduType.M_SP_NA_1,
                    false,
            ...
            try {
                ...
                if (serverCounter == 1) {
                    ...
                    IeSingleCommand singleCommand =
                            (IeSingleCommand) aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    assertTrue(clientTimestamp
                            <= ((IeTime56) aSdu.getInformationObjects()[0].getInformationElements()[0][0])
                                    .getTimestamp());
                    ...
                    aSdu = new ASdu(
                            ...
                            aSdu.getCommonAddress(),
                            new InformationObject[] {
                                new InformationObject(0, new InformationElement[][] {{new IeTime56(serverTimestamp)}})
                            });
                    ...
                    IeDoubleCommand doubleCommand =
                            (IeDoubleCommand) aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    connection.send(new ASdu(
                            ...
                            new InformationObject[] {
                                new InformationObject(
                                        0, new InformationElement[][] {{new IeQualifierOfInterrogation(20)}})
                            }));
                    ...
                    connection.send(new ASdu(
                            ...
                            new InformationObject[] {
                                new InformationObject(1, new InformationElement[][] {
                                    {new IeSinglePointWithQuality(true, true, true, true, true), new IeTime24(50000)}
                                }),
                                new InformationObject(2, new InformationElement[][] {
                                    {
                                        new IeSinglePointWithQuality(false, false, false, false, false),
                    ...
                    connection.send(new ASdu(
                            ...
                            new InformationObject[] {
                                new InformationObject(1, new InformationElement[][] {
                                    {new IeDoublePointWithQuality(DoublePointInformation.OFF, true, true, true, true)}
                                })
                            }));
                    ...
                    connection.send(new ASdu(
                            ...
                            new InformationObject[] {
                                new InformationObject(1, new InformationElement[][] {
                                    {new IeBinaryStateInformation(0xff), new IeQuality(true, true, true, true, true)},
                                    {
                                ...
                                new InformationObject(1, new InformationElement[][] {
                                    {
                                        new IeBinaryCounterReading(
                                                -300, 5, Flag.CARRY, Flag.COUNTER_ADJUSTED, Flag.INVALID)
                                    },
                                ...
                                new InformationObject(1, new InformationElement[][] {
                                    {
                                        new IeSingleProtectionEvent(
                                                IeSingleProtectionEvent.EventState.OFF, true, true, true, true, true),
                                        new IeTime16(300),
                                        new IeTime24(400)
                                    }
                                }),
                    ...
                    connection.send(new ASdu(
                            ...
                            aSdu.getCommonAddress(),
                            new InformationObject[] {
                                new InformationObject(1, new InformationElement[][] {{new IeNormalizedValue(3)}})
                            }));
                    ...
                    connection.send(new ASdu(
                            ...
                            new InformationObject[] {
                                new InformationObject(1, new InformationElement[][] {
                                    {
                                        new IeBinaryCounterReading(
                                                -300, 5, Flag.CARRY, Flag.INVALID, Flag.COUNTER_ADJUSTED),
                                        new IeTime56(serverTimestamp)
                                    }
                                })
                            }));
        ...
        public void newASdu(Connection connection, ASdu aSdu) {
            ...
            try {
                ...
                if (counter == 1) {
                    ...
                    IeSinglePointWithQuality io2 = (IeSinglePointWithQuality)
                            aSdu.getInformationObjects()[1].getInformationElements()[0][0];
                    ...
                    IeSinglePointWithQuality io2 = (IeSinglePointWithQuality)
                            aSdu.getInformationObjects()[0].getInformationElements()[1][0];
                    ...
                    IeValueWithTransientState valueWithTransientState = (IeValueWithTransientState)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];

                    assertEquals(-5, valueWithTransientState.getValue());
                    assertTrue(valueWithTransientState.getTransientState());

                    IeValueWithTransientState valueWithTransientState2 = (IeValueWithTransientState)
                            aSdu.getInformationObjects()[0].getInformationElements()[1][0];

                    assertEquals(-5, valueWithTransientState2.getValue());
                    assertFalse(valueWithTransientState2.getTransientState());

                    IeValueWithTransientState valueWithTransientState3 = (IeValueWithTransientState)
                            aSdu.getInformationObjects()[0].getInformationElements()[2][0];

                    assertEquals(-64, valueWithTransientState3.getValue());
                    assertTrue(valueWithTransientState3.getTransientState());

                    IeValueWithTransientState valueWithTransientState4 = (IeValueWithTransientState)
                            aSdu.getInformationObjects()[0].getInformationElements()[3][0];
                    ...
                    IeBinaryStateInformation binaryStateInformation = (IeBinaryStateInformation)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    IeBinaryStateInformation binaryStateInformation2 = (IeBinaryStateInformation)
                            aSdu.getInformationObjects()[0].getInformationElements()[1][0];
                    ...
                    IeNormalizedValue normalizedValue =
                            (IeNormalizedValue) aSdu.getInformationObjects()[0].getInformationElements()[0][0];

                    assertEquals(-32768, normalizedValue.getUnnormalizedValue());

                    IeNormalizedValue normalizedValue2 =
                            (IeNormalizedValue) aSdu.getInformationObjects()[0].getInformationElements()[1][0];
                    ...
                    IeScaledValue scaledValue =
                            (IeScaledValue) aSdu.getInformationObjects()[0].getInformationElements()[0][0];

                    assertEquals(-32768, scaledValue.getUnnormalizedValue());

                    IeScaledValue scaledValue2 =
                            (IeScaledValue) aSdu.getInformationObjects()[0].getInformationElements()[1][0];

                    assertEquals(10, scaledValue2.getUnnormalizedValue());
                    counter2++;
                } else if (counter == 9) {

                    IeShortFloat scaledValue =
                            (IeShortFloat) aSdu.getInformationObjects()[0].getInformationElements()[0][0];

                    assertEquals(-32768.2, scaledValue.getValue(), 0.1);

                    IeShortFloat scaledValue2 =
                            (IeShortFloat) aSdu.getInformationObjects()[0].getInformationElements()[1][0];

                    assertEquals(10.5, scaledValue2.getValue(), 0.1);
                    counter2++;
                } else if (counter == 10) {

                    IeBinaryCounterReading binaryCounterReading = (IeBinaryCounterReading)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    IeBinaryCounterReading binaryCounterReading2 = (IeBinaryCounterReading)
                            aSdu.getInformationObjects()[0].getInformationElements()[1][0];
                    ...
                    IeSingleProtectionEvent singleProtectionEvent = (IeSingleProtectionEvent)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    IeSingleProtectionEvent singleProtectionEvent2 = (IeSingleProtectionEvent)
                            aSdu.getInformationObjects()[1].getInformationElements()[0][0];
                    ...
                    IeProtectionStartEvent singleProtectionEvent = (IeProtectionStartEvent)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];
                    ...
                    IeProtectionQuality protectionQuality = (IeProtectionQuality)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][1];
                    ...
                    IeStatusAndStatusChanges statusAndStatusChanges = (IeStatusAndStatusChanges)
                            aSdu.getInformationObjects()[0].getInformationElements()[0][0];
